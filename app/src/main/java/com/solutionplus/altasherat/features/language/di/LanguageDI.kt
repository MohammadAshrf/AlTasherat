package com.solutionplus.altasherat.features.language.di

import com.solutionplus.altasherat.common.domain.repository.local.IKeyValueStorageProvider
import com.solutionplus.altasherat.features.language.data.repository.LanguageRepository
import com.solutionplus.altasherat.features.language.data.repository.local.LanguageLocalDS
import com.solutionplus.altasherat.features.language.domain.interactor.GetSelectedCountryUC
import com.solutionplus.altasherat.features.language.domain.interactor.SaveSelectedCountryUC
